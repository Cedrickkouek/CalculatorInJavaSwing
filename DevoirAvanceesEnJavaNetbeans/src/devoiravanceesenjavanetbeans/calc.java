...
public class calc extends javax.swing.JFrame {
   ...
   public void ops_arithmetics(String[] inputParts) {
    // Check if the inputParts array is not empty
    ...
    if (inputParts.length == 3) { // Make sure we have two numbers and an operator
        double num1 = Double.parseDouble(inputParts[0]);
        String operator = inputParts[1];
        double num2 = Double.parseDouble(inputParts[2]);
        ...
        switch (operator) {
            ...
            default:
                ...
                jTextField2.setText("Invalid Operator");
                return;
        }
        ...
        jTextField2.setText("Invalid Input Format");
    }
}
    ...
    private void initComponents() {
        ...
        setLocation(new java.awt.Point(750, 500));
        ...
        jButton17.setFont(new java.awt.Font("Tahoma", 0, 65)); // NOI18N
        jButton17.setText("=");
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jButton17, javax.swing.GroupLayout.PREFERRED_SIZE, 315, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
       ...
       String input = jTextField1.getText();
        ...
        // Use Pattern and Matcher to capture the operator
        Pattern pattern = Pattern.compile("\\s*([-+*/])\\s*");
        Matcher matcher = pattern.matcher(input);

        // Use find to check if the pattern is found
        if (matcher.find()) {
            // Split the input and include the numbers and operator in the resulting array
            String[] parts = pattern.split(input);

            // Insert the operator in the middle of the two numbers
            String operator = matcher.group(1);
            parts = new String[]{parts[0], operator, parts[1]};

            // Call the ops_arithmetics method and update the result in jTextField2
            ops_arithmetics(parts);
        } else {
            // Handle the case where the operator is not found
            System.out.println("Operator not found in the input");
        }
